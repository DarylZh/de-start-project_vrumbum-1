...
-- Шаг 1. После скачивания файла заменила null на пустые
...
--не сработало в терминале и dbeaver нет прав супервизора, поэтому я использовала импорт файла csv в DBeaver
